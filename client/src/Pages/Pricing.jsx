      ...
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="flex justify-center gap-8">
          ...
          <div className="bg-white rounded-lg shadow-lg border-4 border-3bb19b p-6 w-full md:w-1/3">
            ...
            <a href="#" className="block text-center bg-3bb19b text-white border-2 border-3bb19b py-3 px-6 rounded-lg transition duration-200 hover:py-4 hover:px-7 hover:underline" style={{ backgroundColor: '#3bb19b', color: '#ffffff' }}>Subscribe Now</a>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-lg border-4 border-3bb19b p-6 w-full md:w-1/3">
            ...
            <a href="#" className="block text-center bg-3bb19b text-white border-2 border-3bb19b py-3 px-6 rounded-lg transition duration-200 hover:py-4 hover:px-7 hover:underline" style={{ backgroundColor: '#3bb19b', color: '#ffffff' }}>Contact Us</a>
          </div>
        </div>
      </div>
    </div>
